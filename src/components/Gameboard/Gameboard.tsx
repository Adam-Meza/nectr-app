  ...
  return (
    <main>
      ...
      <div className="button-container">
        <button className="game-play-button" onClick={() => deleteLastLetter()}>
          Delete
        </button>
        <button className="game-play-button" onClick={() => randomizeLetters()}>
          Randomize
        </button>
        <button className="game-play-button" onClick={() => handleSubmit()}>
          Enter
        </button>
      </div>
    </main>
